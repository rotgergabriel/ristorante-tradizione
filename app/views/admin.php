...
// --- 1. LÓGICA DE ESCRITURA (ELIMINAR, GUARDAR, EDITAR) ---
    ...
    if (!empty($_POST['recipe_title']) && !empty($_POST['recipe_description'])) {
        ...
        if (!empty($recipe_id)) {
            ...
            $sql = "UPDATE recipes SET 
                    ...
                    complete_process='$complete_process', preparation_time='$preparation_time' 
                    WHERE id = $recipe_id";
            $message = "¡Ricetta aggiornata con successo!";
        } else {
            $sql = "INSERT INTO recipes (title, subtitle, description, complete_process, preparation_time) 
                    VALUES ('$title', '$subtitle', '$description', '$complete_process', '$preparation_time')";
...
// --- 2. LÓGICA DE PAGINACIÓN Y BÚSQUEDA ---
...
// Consulta final para la lista (LIMITADA)
...
<head>
    ...
    <title>Pannello di Amministrazione - Ricette</title>
...
<body class="admin-body">
    <header class="admin-header">
        ...
        <nav class="admin-nav">
            <ul>
                <li><a href="<?php echo BASE_URL; ?>app/views/login.php">Esci</a></li>
            </ul>
        </nav>
    </header>
        ...
        <div class="dashboard-container">
            <section class="content-section form-column">
                <h2 class="section-title">
                    <?php echo $row_edit['id'] ? 'Modifica Ricetta' : 'Aggiungi Ricetta'; ?>
                </h2>
                ...
                <form action="" method="POST" class="recipe-form" enctype="multipart/form-data">
                    ...
                    <div class="form-actions-edit">
                        ...
                        <div class="secondary-actions">
                            <?php if ($row_edit['id']): ?>
                                <a href="admin.php" class="btn-secondary" style="text-decoration:none; display:inline-block; padding:10px;">🔄 Annulla</a>
                            <?php else: ?>
            ...
            <section class="list-column">
                ...
                <div class="recipe-list">
                    <?php
                    // Usamos el stmt que ya tiene el LIMIT y OFFSET aplicado arriba
                    ...
                    <div class="pagination">
                        ...
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            // Lógica para mostrar:
                            // 1. La primera y la última página siempre
                            // 2. Las páginas que están dentro del rango de la página actual
